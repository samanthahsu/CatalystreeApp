...
public class FWater extends Fragment{
...
//        inflating the view
        final View rootView = inflater.inflate(R.layout.fragment_water, container, false);
//        declaring stuff, not sure why it has to be final
        final EditText ETcost;
        Button btnSubmitElec;

        ETcost = (EditText) rootView.findViewById(R.id.ET_water_cost);

//      create new car database
        waterDataBaseAdapter = new WaterDataBaseAdapter(getActivity());
        waterDataBaseAdapter = waterDataBaseAdapter.open();

        session = new SessionManagement(getActivity().getApplicationContext());

//      identifying the button
        btnSubmitElec = (Button) rootView.findViewById(R.id.button_water_submit);
...
//                convert distance to integer
                                                    ...
                                                    waterDataBaseAdapter.insertEntry(username, date, cost);
